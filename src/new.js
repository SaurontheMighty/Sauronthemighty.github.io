        ...
        <body>
            ...
            <div className="main-text">
                ...
                <ul className="project-list">
                    ...
                    <li><span className="status-archived" title="Archived">●</span><span className="project-year">2025</span><a href="https://posturing.app">Posturing</a> — Posture reminders for Mac that show you a live feed of your posture</li>
